 ...
 */
    ...
    hasMajorDiagonalConflictAt: function(columnAndRow) {
      var row = columnAndRow[0];
      var col = columnAndRow[1];
      var counter = 0;
    ...
    hasMinorDiagonalConflictAt: function(columnAndRow) {
      var row = columnAndRow[0];
      var col = columnAndRow[1];
      var counter = 0;
      var n = this.attributes.n;
